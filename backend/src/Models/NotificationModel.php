...
final class NotificationModel
{
    ...
    public function findById(string $id): ?array
    {
        ...
        $st = $this->pdo->prepare('SELECT * FROM notifications WHERE id = :id LIMIT 1');
    ...
    public function countDocuments(array $filter): int
    {
        ...
        $sql = 'SELECT COUNT(*) FROM notifications ' . ($whereSql ? "WHERE {$whereSql}" : '');
    ...
    public function create(array $data): array
    {
        ...
        $sql = 'INSERT INTO notifications (' . implode(', ', $cols) . ')
    ...
    public function updateById(string $id, array $updates): ?array
    {
        ...
        $sql = 'UPDATE notifications SET ' . implode(', ', $set) . ' WHERE id = :id';
        $st = $this->pdo->prepare($sql);
    ...
    public function deleteById(string $id): bool
    {
        ...
        $st = $this->pdo->prepare('DELETE FROM notifications WHERE id = :id');
        $st->execute([':id' => (int)$id]);
